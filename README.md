...
#> Class 1:
#>   Outcome Category 2 (vs Category 1) ON
#>     Intercept       0.514  [ 0.240,  1.101]     0.087
#>     Z1              0.657  [ 0.398,  1.084]     0.100
#> 
#> Class 2:
#>   Outcome Category 2 (vs Category 1) ON
#>     Intercept       4.334  [ 2.992,  6.277]    < .001
#>     Z1              1.115  [ 0.819,  1.518]     0.488
#> 
#> Class 3:
#>   Outcome Category 2 (vs Category 1) ON
#>     Intercept       0.772  [ 0.383,  1.556]     0.469
#>     Z1              0.621  [ 0.348,  1.110]     0.108
#> =========================================================
```
