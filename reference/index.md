...
- [`blrt()`](https://pdvalencia.github.io/mixtureEM/reference/blrt.md)
  [`calc_blrt()`](https://pdvalencia.github.io/mixtureEM/reference/blrt.md)
...
- [`coef(`*`<mixture_model>`*`)`](https://pdvalencia.github.io/mixtureEM/reference/coef.mixture_model.md)
...
- [`plot(`*`<lcga>`*`)`](https://pdvalencia.github.io/mixtureEM/reference/plot.lcga.md)
...
- [`poisson_model()`](https://pdvalencia.github.io/mixtureEM/reference/poisson_model.md)
  : Constructor for Poisson (count) models
- [`print(`*`<gmm>`*`)`](https://pdvalencia.github.io/mixtureEM/reference/print.gmm.md)
  : Print a Fitted Growth Mixture Model
- [`print(`*`<lcga>`*`)`](https://pdvalencia.github.io/mixtureEM/reference/print.lcga.md)
...
- [`summary(`*`<lta_model>`*`)`](https://pdvalencia.github.io/mixtureEM/reference/summary.lta_model.md)
